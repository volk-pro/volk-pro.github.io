...
{var registry=IWCreateEffectRegistry();registry.registerEffects({shadow_0:new IWShadow({blurRadius:7,offset:new IWPoint(7.0000,-0.0000),color:'#3a060f',opacity:0.500000}),shadow_1:new IWShadow({blurRadius:7,offset:new IWPoint(7.0000,-0.0000),color:'#3a060f',opacity:0.500000})});registry.applyEffects();}
function hostedOnDM()
{return false;}
function onPageLoad()
